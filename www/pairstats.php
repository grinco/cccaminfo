...
if ($total_servers>0)
{
   ...
   echo "<tr>";
	...
	echo "<td class=\"tabel_total\" COLSPAN=2><!--<A HREF=$pagina?sort=$sort&resetECM=1>Reset ECM</A>--></td>";
	echo "<td class=\"tabel_total\" COLSPAN=2></td>";
	echo "</tr>";
   ...
   { 
         ...
         */
         ...
         if (isset($clientConectat[$Client_afisat]))
            echo "<A HREF=".$pagina."?username=$Client_afisat>".$Client_afisat."</A>"."<BR>";
         	...
         	echo "<A HREF=".$pagina."?username=$Client_afisat><FONT COLOR=red>".$Client_afisat."</FONT></A>"."<BR>";
      ...
      $notes_saved[0] = "";	
	   ...
	   if (isset($notes_saved[0]))
      	echo "<td class=\"Node_ID\">".$notes_saved[0]."</td>";
      else
      	echo "<td class=\"Node_ID\"></td>";
